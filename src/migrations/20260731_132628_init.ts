...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   DROP TABLE "payload_admins_sessions" CASCADE;
  DROP TABLE "payload_admins" CASCADE;
  DROP TABLE "schools" CASCADE;
  DROP TABLE "class_levels" CASCADE;
  DROP TABLE "books" CASCADE;
  DROP TABLE "uniform_items_size_options" CASCADE;
  DROP TABLE "uniform_items" CASCADE;
  DROP TABLE "stationery_items" CASCADE;
  ...
  DROP TYPE "public"."enum_uniform_items_category";
  ...
  DROP TYPE "public"."enum_receipts_redemption_status";`)
}
