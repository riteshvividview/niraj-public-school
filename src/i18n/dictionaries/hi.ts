...
const hi: Dictionary = {
  ...
  common: {
    ...
    showAtEntry: "चेक-इन के लिए यह प्रवेश द्वार पर दिखाएं",
    ticketLabel: "टिकट",
    back: "वापस",
    change: "बदलें",
  },
  ...
  programsPage: {
    ...
    filterMaxFeeLabel: "अधिकतम शुल्क",
    filterAnyFee: "कोई भी शुल्क",
    filterSortLabel: "इसके अनुसार क्रमबद्ध करें",
    sortDate: "तारीख (सबसे जल्दी पहले)",
    sortFeeAsc: "शुल्क (कम से ज़्यादा)",
    sortFeeDesc: "शुल्क (ज़्यादा से कम)",
    clearFilters: "फ़िल्टर हटाएं",
    noResultsTitle: "आपके फ़िल्टर से कोई कार्यक्रम मेल नहीं खाता",
    noResultsDescription: "कोई फ़िल्टर हटाकर देखें या नए कार्यक्रमों के लिए बाद में वापस आएं।",
    categories: {
      workshop: "कार्यशाला",
      sports: "खेल",
      camp: "कैंप",
      annualDay: "वार्षिकोत्सव",
      exhibition: "प्रदर्शनी",
      extraClass: "अतिरिक्त कक्षा",
    },
    venueLabel: "स्थान",
    dateLabel: "तारीख",
    feeLabel: "शुल्क",
    ...
    fullDescription: "सभी सीटें भर चुकी हैं। किसी सीट के खाली होने पर बाद में फिर देखें।",
    alreadyInCart: "पहले से ही आपके कार्ट में है",
